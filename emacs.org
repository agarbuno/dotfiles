...
First, add the style in the home of the tex configuration. In my case, in MacOS this is =/usr/local/texlive/2018/texmf-dist/tex/latex/base/=. For example I am using ~imsart~ article style. So my custom class is
