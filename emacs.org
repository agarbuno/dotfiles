...
- [[#productivity][Productivity]]
  - [[#latex-editing][Latex editing]]
    ...
    - [[#toggle-between-bib-files][Toggle between bib files]]
    - [[#citar-for-bib-management][Citar for bib management]]
...
>>>>>>> 6e08034abb887b003130bfd68c523ced49e8010d
...
*** Citar for bib management                                      :pending:
...
$\LaTeX$ rendering is very small in my configuration. I needed to scale it up. See for example here: $y = f(x) + \epsilon$.
