...
#+begin_src emacs-lisp
    ...
    (use-package deft
      ...
      (setq ag/deft-dir-list '("/Users/ag/Google Drive/orgfiles/notes"
                                     "/Users/ag/Google Drive/orgfiles/notes/Journal"
                                       "/Users/ag/Google Drive/orgfiles/notes/References"
                                     ))
...
#+begin_src emacs-lisp
  (defun ag/org-present-prepare-slide ()
    (org-overview)
    (org-show-entry)
    (org-show-children))

  (defun ag/org-present-hook ()
    ...
    (ag/org-present-prepare-slide))

  (defun ag/org-present-quit-hook ()
  ...
  (defun ag/org-present-prev ()
    (interactive)
    (org-present-prev)
    (ag/org-present-prepare-slide))

  (defun ag/org-present-next ()
    (interactive)
    (org-present-next)
    (ag/org-present-prepare-slide))
  ...
  (use-package org-present
    :bind (:map org-present-mode-keymap
           ("C->" . ag/org-present-next)
           ("C-<" . ag/org-present-prev))
    :hook ((org-present-mode . ag/org-present-hook)
           (org-present-mode-quit . ag/org-present-quit-hook)))
#+end_src
** Org-tree-slide
