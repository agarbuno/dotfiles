...
#+begin_src emacs-lisp
  ...
  (cl-defmethod org-roam-node-functiontag ((node org-roam-node))
    ...
    (let* ((specialtags kb/lit-categories)
      ...
      (concat
       (if functiontag
           (propertize "=@=" 'display (all-the-icons-faicon "tags" :face 'all-the-icons-dgreen :v-adjust 0.02 :cache yesheight 0.7))
...
#+begin_src emacs-lisp
  ...
  (setq org-roam-node-display-template (concat "${backlinkscount:16}" "${othertags:40}" "${hierarchy:*}"))
#+end_src
