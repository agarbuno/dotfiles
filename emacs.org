...
#+begin_src emacs-lisp
        (use-package org-roam-bibtex
          ...
          ;; since I use ivy-bibtex
          (setq bibtex-completion-bibliography '("~/Google Drive/orgfiles/references/bibliography.bib"
                                                 "~/Google Drive/orgfiles/references/bibliographypdfs.bib")
                bibtex-completion-library-path "~/Google Drive/orgfiles/references/bibtex-pdfs"
...
#+begin_src emacs-lisp
    (use-package latex
      ...
      ;; pdf-tools  zooming to better rendering
