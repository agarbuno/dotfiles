...
- =evil-window-down= - ~C-w j~
  ...
  #+begin_src emacs-lisp
    ;; For macOS type of keybindings
    (global-set-key (kbd "<M-A-up>")    'evil-window-up)
    (global-set-key (kbd "<M-A-down>")  'evil-window-down)
    (global-set-key (kbd "<M-A-left>")  'evil-window-left)
    (global-set-key (kbd "<M-A-right>") 'evil-window-right)
  #+end_src
