...
- [[#org-mode][Org Mode]]
  ...
  - [[#emacs-environments-for-teachingwork][Emacs environments for teaching/work]]
...
** Emacs environments for teaching/work

First, define the theme and call the supporting text/indent/tabs and cosmetics for my org-setup.
...
and =.sty= files into the LaTeX home.  So my custom class is
